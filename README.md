...
## Requirements
The only dependency is the Zig Compiler, version `0.17.0-dev.1946+d813faaf0`: [Linux](https://ziglang.org/builds/zig-x86_64-linux-0.17.0-dev.1946+d813faaf0.tar.xz)/[Windows](https://ziglang.org/builds/zig-x86_64-windows-0.17.0-dev.1946+d813faaf0.zip)
